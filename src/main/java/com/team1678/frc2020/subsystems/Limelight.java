    ...
    public void registerEnabledLoops(ILooper mEnabledLooper) {
        Loop mLoop = new Loop() {
            ...
            public void onLoop(double timestamp) {
                synchronized (this) {
                    if (Hood.getInstance().getAtGoal() && !Superstructure.getInstance().getTucked() && !Superstructure.getInstance().getWantFendor()  && !Superstructure.getInstance().getWantSpit() && mPeriodicIO.has_comms) {

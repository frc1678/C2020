...
import com.team1678.frc2020.ScoringPosition;
...
public class LimelightManager extends Subsystem {
    ...
    public synchronized void updatePipeline(ScoringPosition scoringPosition) {
        if (scoringPosition == ScoringPosition.HIGH) {
            setPipeline(Limelight.kHighGoalPipeline);
        } else {
            setPipeline(Limelight.kLowGoalPipeline);
        }
    }
}
